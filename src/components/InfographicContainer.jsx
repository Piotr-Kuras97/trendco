    ...
    return ( 
        <div className="infographic">
            <div className="infographic__text-container">
                <h3 className="infographic__title" data-aos="zoom-in-up" data-aos-once='true' data-aos-delay='250'>
                    Odkryj Naszą Paletę Kategorii
                </h3>
                <p className="infographic__text" data-aos="zoom-in-up" data-aos-once='true' data-aos-delay='500'>
